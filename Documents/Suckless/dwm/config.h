...
static const char *fonts[]          = { "JetBrainsMonoNerdFont-Medium:size=10" };
static const char dmenufont[]       = "monospace:size=10";
static const char col_black[]       = "#000000";
static const char col_lblack[]       = "#150f0f";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_white, col_lblack, col_lblack },
...
static const Key keys[] = {
	...
	{ 0,                            XK_F6,     spawn,          SHCMD("sudo screenlight.sh up") },
	{ 0,                            XK_F5,     spawn,          SHCMD("sudo screenlight.sh down") },
